...
public class MultiplayerVideoManager : MonoBehaviourPunCallbacks
{
    ...
    public VideoType PlayingVideoType;
    ...
    private void OnEnable()
    {
        ...
        MediaPresentationManager.LoadMediaAcrossAllPlayers += LoadVideoRPC;
    }
    ...
    public void LoadNetworkVideoUrl()
    {
    ...
    public void LoadNetworkVideoUrl(string mediaUrl,FilePicker.MediaType mediaType)
    {
        PlayVideo(false, "Aws", mediaUrl);
    }

    public void LoadVideoRPC(string mediaUrl,FilePicker.MediaType mediaType)
    {
        PlayVideo(false, "Aws", mediaUrl);
    }
    ...
    async void GetVideo(int DomeId)
    {
        ...
        {
            if (_DomeGeneralData.domes_media_v2.mediajson != null && _DomeGeneralData.domes_media_v2.mediajson.Length > MediaIndex)
            {
                VideoUrl = _DomeGeneralData.domes_media_v2.mediajson[MediaIndex].mediaUrl;
                PlayVideo(_DomeGeneralData.domes_media_v2.mediajson[MediaIndex].isYoutubeUrl, _DomeGeneralData.domes_media_v2.mediajson[MediaIndex].videoUrlType, _DomeGeneralData.domes_media_v2.mediajson[MediaIndex].mediaUrl);
            }
        }
    }
    ...
    async void CheckForUrlRefresh(int DomeId)
    {
        ...
        while (CheckForAutoRefresh)
        {
            ...
            if (_DomeGeneralData.dome.mediajson != null && _DomeGeneralData.dome.mediajson.Length > MediaIndex)
            {
                if (VideoUrl != _DomeGeneralData.dome.mediajson[MediaIndex].mediaUrl)
                {
                    ...
                    VideoUrl = _DomeGeneralData.dome.mediajson[MediaIndex].mediaUrl;
                    PlayVideo(_DomeGeneralData.dome.mediajson[MediaIndex].isYoutubeUrl, _DomeGeneralData.dome.mediajson[MediaIndex].videoUrlType, _DomeGeneralData.dome.mediajson[MediaIndex].mediaUrl);
                }
            }
