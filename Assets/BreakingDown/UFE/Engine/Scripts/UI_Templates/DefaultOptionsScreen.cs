...
namespace BD
{
	...
	public class DefaultOptionsScreen : OptionsScreen
	{
		...
		public override void OnShow()
		{
			...
			{
				this.musicSlider.value = UFE.config.DefalutMusicVolume;
            }

            if (this.BGM != null)
            {
                this.BGM.value = UFE.config.DefalutBgmVolume;
            }
			...
			{
				this.soundSlider.value = UFE.config.DefalutSoundfxVolume;
            }
        ...
        public virtual void SetBGMVolume(Slider slider)
        {
            if (this.visible && slider != null)
            {
                this.SetBGMVolume(slider.value);
            }
        }
        ...
        public override void SetBGMVolume(float volume)
        {
            if (this.visible)
            {
                base.SetBGMVolume(volume);

                if (this.BGM != null)
                {
                    this.BGM.value = this.GetBGMVolume();
                }
            }
        }
