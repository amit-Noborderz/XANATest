...
public class PhysicsScript : MonoBehaviour {
    ...
    public void Start()
    {
        ...
        //{
        //    controlScript.myInfo.physics._moveForwardSpeed = 60 / 10f; //Instead of 60 place API speed value
        //    controlScript.myInfo.physics._moveBackSpeed = 60 / 10f; //Instead of 60 place API speed value
        //}
        //if (this.name == "Player2")
        //{
        //    controlScript.myInfo.physics._moveForwardSpeed = 80 / 10f; //Instead of 80 place API speed value
        //    controlScript.myInfo.physics._moveBackSpeed = 80 / 10f;//Instead of 80 place API speed value
        //}
