...
{
    private int _maxTriesToUPloadProfile = 3;
    ...
    public void PostAvatarObject(string fileName, string key, string CallingFrom)
    {
        ...
        PostObjectMethodAvatar(myData, fileName1, callback =>
        {
            ...
            {
                if (_maxTriesToUPloadProfile > 0)
                {
                    _maxTriesToUPloadProfile--;
                    PostAvatarObject(fileName, key, CallingFrom);
                }
            }
        });
    }
